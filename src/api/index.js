...
// pdf记录添加添加
export const produceTaskPrint = query => {
  return request({
    url: '/api/producetask/produceTaskPrint',
    data:query,
    method: 'post',
  })
}
...
// pdf打印分页
export const produceTaskPrintpage = query => {
  return request({
      url: `/api/producetask/produceTaskPrint/page`,
      method: 'get',
      params:query
  });
}
...
//pdf记录删除
export const produceTaskPrintid = query => {
  return request({
      url: `/api/producetask/produceTaskPrint/${query.id}`,
      method: 'delete',
  });
}
...
export const pageByProduceTaskPlanId = query => {
  return request({
      ...
      method: 'get',
      params:query,
      headers: {'userId': sessionStorage.getItem('userId'),'roleId': sessionStorage.getItem('roleId')}
  });
}
...
// 生产合格率
export const getProduceQualifiedRate = query => {
  return request({
      url: `/api/producetask/produceStatistics/getProduceQualifiedRate`,
      method: 'get',
      params:query
  });
}

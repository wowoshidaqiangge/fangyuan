<!-- 方圆阀门大屏 -->
<template>
  <el-main class="globalPage" element-loading-text="加载中。。。" element-loading-background="RGBA(0, 18, 53, 0.5)">
    <div class="header">
      <!-- <div class="leftWelcome">
        <div class="welcomeText">欢迎您，{{ userName }}</div>
      </div> -->
      <div class="centerTitle">
        <div class="titleContent" @click="goControl">方圆阀门生产管理系统</div>
      </div>
      <!-- <div class="rightTime">
        ...
        <div class="middle">
          <div class="midTop">
            ...
            <div class="deviceInfo">
              <div class="infoBox">
                <div class="imgBox">
                  <img src="~@/assets/img/globalPage/icon1.png">
                </div>
                <div class="textBox">
              ...
              <div class="infoBox">
                <div class="imgBox">
                  <img src="~@/assets/img/globalPage/icon2.png">
                </div>
                <div class="textBox">
              ...
              <div class="infoBox">
                <div class="imgBox">
                  <img src="~@/assets/img/globalPage/icon3.png">
                </div>
                <div class="textBox">
...
// 巡检维修 巡检统计
// import inspection from './globalPage/inspection'
// 业务数量统计
// import businessNum from './globalPage/businessNum'
// 考勤数据
// import attendance from './globalPage/attendance'
// 月巡检维修次数
// import monthrepair from './globalPage/monthrepair'
// 设备信息
// import deviceInfo from './deviceInfo'
// 工单信息
// import workinfo from './globalPage/workinfo'
// 本月每日工单数
// import monthwork from './globalPage/monthwork'
export default {
  components: {
    //  attendance,inspection,deviceInfo
    // businessNum, monthrepair, monthwork, workinfo
  },
  data() {
    return {
      ...
      .middle {
        ...
        .midTop {
          ...
          .mapBox {
            ...
            width: 100%;
            height: 70%;
            background: url('~@/assets/img/globalPage/map.png')
              no-repeat;
            background-size: 100% 100%;
          }
        }
...
.title {
  ...
  color: #00ffff;
  font-size: 14px;
  border-top: 1px solid RGBA(0, 108, 200, 1);
  border-bottom: 1px solid RGBA(0, 108, 200, 1);
  margin-top: -1%;
  margin-left: 15%;
  text-align: center;
}
.title:after {
  ...
  border-top: 1px solid RGBA(0, 108, 200, 1);
  border-right: 1px solid RGBA(0, 108, 200, 1);
}
.title:before {
  content: '';
  position: absolute;
  ...
  -o-transform: rotate(45deg);
  border-bottom: 1px solid RGBA(0, 108, 200, 1);
  border-left: 1px solid RGBA(0, 108, 200, 1);
}
</style>
